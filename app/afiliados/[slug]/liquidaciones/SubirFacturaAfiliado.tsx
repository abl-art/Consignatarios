...
import { subirFacturaAfiliado } from '@/lib/actions/liquidaciones-afiliados'

export default function SubirFacturaAfiliado({
  liquidacionId,
  tieneFactura,
}: {
  ...
  async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const res = await subirFacturaAfiliado(liquidacionId, formData)
