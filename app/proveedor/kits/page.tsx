...
export default async function ProveedorKitsPage({
  ...
  const tabStock = celulares.length > 0 ? (
    <StockCelulares rows={celulares} />
  ) : (
    <p className="text-sm text-gray-400 py-6">El stock de celulares no está disponible en este momento.</p>
  )
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-gray-900">GOcelular — Vista Proveedor</h1>
      ...
      <div className="max-w-6xl mx-auto p-6">
        <FinanzasTabs
          tabs={[
            { id: 'kits', label: 'Kits de Seguridad', content: tabKits },
            { id: 'stock-celulares', label: 'Stock Celulares', content: tabStock },
          ]}
        />
      </div>
    </div>
