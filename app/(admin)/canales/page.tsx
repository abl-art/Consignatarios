...
const canales = [
  ...
  {
    href: '/canales/mayoristas',
    title: 'Mayoristas',
    description: 'Venta mayorista con proformas y cuenta corriente',
    color: 'rose',
  ...
  },
  {
    href: '/upselling',
    title: 'Upselling',
    description: 'Clientes con todas las cuotas pagas — contacto, notas y recompras',
    color: 'indigo',
