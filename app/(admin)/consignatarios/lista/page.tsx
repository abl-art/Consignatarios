...
async function crearConsignatario(formData: FormData) {
  ...
  revalidatePath('/consignatarios/lista')
}

export default async function ConsignatariosListaPage() {
  const supabase = createClient()
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-1 mt-2">Lista de Consignatarios</h1>
      <p className="text-sm text-gray-500 mb-6">Gestionar consignatarios y crear nuevos</p>
